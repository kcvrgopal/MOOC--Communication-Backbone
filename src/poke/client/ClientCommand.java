...
public class ClientCommand {
	...
	public void job(String tag, int num) {
		// data to send
		JobOperation.Builder f = eye.Comm.JobOperation.newBuilder();
		f.setAction(JobAction.ADDJOB);
	...
	public void request() {
		// data to send
		NameSpaceOperation.Builder f = NameSpaceOperation.newBuilder();
		f.setAction(SpaceAction.LISTSPACES);
		// payload containing data
		Request.Builder r = Request.newBuilder();
		eye.Comm.Payload.Builder p = Payload.newBuilder();
		p.setSpaceOp(f.build());
		r.setBody(p.build());
