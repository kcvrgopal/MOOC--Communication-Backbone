 ...
 * A and B, node A has a interest to node B. Node B will send a heartbeatMgr to
 * A rather than A ping's node B. We implement a push model to allow A to
 ...
 * active. On connection loss, the emitting node (e.g., node B) will wait for
...
public class HeartbeatData {
	...
	public HeartbeatData(String nodeId, String host, Integer port,
			Integer mgmtport) {
		this.nodeId = nodeId;
		this.host = host;
		this.port = port;
	 ...
	 * need to provide a way to initialize the metadata from the connection data
	 * 
	 * @param channel
	 * @param sa
	 */
