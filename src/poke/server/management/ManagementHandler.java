...
public class ManagementHandler extends
	...
	@Override
	public void channelRead0(ChannelHandlerContext ctx, eye.Comm.Management req)
			throws Exception {
		// processing is deferred to the worker threads
		logger.info("---> management got a message");
		ManagementQueue.enqueueRequest(req, ctx.channel(), ctx.channel()
				.remoteAddress());
	}
